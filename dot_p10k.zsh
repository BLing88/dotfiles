# Generated by Powerlevel10k configuration wizard on 2019-08-18 at 15:19 EDT.
...
() {
  ...
  ##################################[ dir: current directory ]##################################
  # Set current directory background color
  ...
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='%49F\uF126 '
  ...
  local vcs=''
  # If on a branch...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%49F'${(g::)POWERLEVEL9K_VCS_BRANCH_ICON} #default color is 76
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=49 #default is 76
  # Custom icon.
